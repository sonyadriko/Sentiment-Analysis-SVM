...
def SVM():
    ...
    X_train, X_test, y_train, y_test = train_test_split(XNum, yNum, test_size=0.2, random_state=42)
    ...
    similarities = cosine_similarity(X_test, XNum)

    # Get ranking based on similarities
